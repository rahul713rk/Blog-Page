...
## Exercises
1. Write a one-page implementation brief for Security Mini Projects including objective, owners, constraints, and success metrics.
...
6. Run a tabletop incident scenario related to Security Mini Projects; document timeline, decisions, and improvement actions.
