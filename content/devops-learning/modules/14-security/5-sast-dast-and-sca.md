...
## Exercises
1. Write a one-page implementation brief for SAST, DAST, and SCA including objective, owners, constraints, and success metrics.
...
6. Run a tabletop incident scenario related to SAST, DAST, and SCA; document timeline, decisions, and improvement actions.
