...
## Exercises
1. Write a one-page implementation brief for Shift-Left Security including objective, owners, constraints, and success metrics.
...
6. Run a tabletop incident scenario related to Shift-Left Security; document timeline, decisions, and improvement actions.
