...
## Exercises
1. Write a one-page implementation brief for SRE vs DevOps including objective, owners, constraints, and success metrics.
...
6. Run a tabletop incident scenario related to SRE vs DevOps; document timeline, decisions, and improvement actions.
