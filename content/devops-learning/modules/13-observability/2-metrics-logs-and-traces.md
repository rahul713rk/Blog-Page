...
## Exercises
1. Write a one-page implementation brief for Metrics, Logs, and Traces including objective, owners, constraints, and success metrics.
...
6. Run a tabletop incident scenario related to Metrics, Logs, and Traces; document timeline, decisions, and improvement actions.
