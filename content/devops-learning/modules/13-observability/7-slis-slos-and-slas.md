...
## Exercises
1. Write a one-page implementation brief for SLIs, SLOs, and SLAs including objective, owners, constraints, and success metrics.
...
6. Run a tabletop incident scenario related to SLIs, SLOs, and SLAs; document timeline, decisions, and improvement actions.
