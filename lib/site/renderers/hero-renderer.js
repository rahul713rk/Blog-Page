...
function renderArchiveHero(pageNumber, customTitle = null) {
  const title = customTitle || `Archive - Page ${pageNumber}`;
  return `<section class="archive-hero reveal-on-scroll"><h1>${title}</h1></section>`;
}
